...
typedef enum {
    TYON_PROFILE_SETTINGS_LIGHTS_ENABLED_BIT_WHEEL = 0x01, //EOF-BUGFIX: 0 -> 1
    TYON_PROFILE_SETTINGS_LIGHTS_ENABLED_BIT_BOTTOM = 0x02,
    TYON_PROFILE_SETTINGS_LIGHTS_ENABLED_BIT_CUSTOM_COLOR = 0x10, //EOF-BUGFIX: 0x04 -> 0x10
...
typedef enum {
    ROCCAT_TALKFX_ZONE_AMBIENT = 0x01, //EoF-BUGFIX: 0x00 -> 0x01
    ROCCAT_TALKFX_ZONE_EVENT = 0x02,   //EoF-BUGFIX: 0x01 -> 0x02
